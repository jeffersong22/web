...
El objetivo con todos nuestros sitios web es que no dependan del dispositivo.</p>
...
En Softweb no nos limitamos a crear simples catálogos electrónicos. Nuestra experiencia de casi una década en mercadotecnia en Internet y los más de veinte años en tecnologías de la información nos permiten ofrecer a nuestros clientes las mejores soluciones, aplicando las técnicas de diseño web más convenientes de acuerdo a los objetivos específicos de cada empresa.
			...
			<article class="serv1">
				<h4>Mantenimiento de Páginas Web</h4>
				<figure>
					<img src="imagenes/seniority-programadores.jpg" alt="">
				</figure>
				<p>
...
Muchos empresarios y ejecutivos lo desconocen, pero en un proyecto de mercadotecnia por Internet el verdadero compromiso lo adquiere uno precisamente en el momento de publicar la primera versión de nuestro sitio web. Sus propios clientes le indicarán a usted los temas y frecuencia de las actualizaciones a su página web que en su momento sean necesarias.				</p>
				
			</article>
		</section>
		<center>
			<footer>
			<p>Diseño y Desarrollo Web By</p>
			<h5>Jefferson Gomez - 2020 - www.SoftwebM.com </h5> 
